...
module.exports =
  ...
  create: (context) ->
    ...
    "CallExpression[callee.name='flowMax']": (node) ->
      ...
      for argument in node.arguments
        if (
          argument?.type is 'CallExpression' and
          argument.callee.type is 'Identifier' and
          argument.callee.name is 'addDisplayName'
        )
          return
